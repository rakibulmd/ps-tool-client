      ...
      <div className="container mx-auto pt-10 lg:pt-[90px]">
        <div className="md:flex justify-between">
          <div className="md:w-1/2 order-2">
             <img src={HeroPrinters} className="z-10 lg:min-w-[100%] h-auto"></img>
          </div>
          <div className="md:w-1/2 -mt-5 md:mt-0 md:pt-16 order-1 pl-6 lg:pl-0">
            ...
            <Button className="bg-white text-[#00acef] text-sm md:text-md lg:text-lg mt-8 mb-8 font-bold tracking-wide">See Solutions</Button>
          </div>
        </div>
      </div>
    </div>
